...
<head>
    ...
    <link rel="stylesheet" href="/build/assets/dashboard-BE8_mQFJ.css" type="text/css">
    ...
    <link rel="stylesheet" href="/build/assets/app-Ca-_sS95.css" type="text/css">
...
<body>
    ...
    <div class="send-email" id="send-email">
        ...
        <div class="email">
            ...
            @endif
            <form class="row" action="https://bigboss-project.vercel.app/contact" method="POST">
                @csrf
                <div class="title">
    ...
    <script src="/build/assets/app-DCgXsla_.js"></script>
